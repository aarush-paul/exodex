package com.cse.exodex.datasets;

import com.cse.exodex.datasets.catalogs.GlieseCatalog;
...
public class ConstellationCorpus {
  ...
  public ConstellationCorpus() throws IOException {
    InputStream resourceAsStream = GlieseCatalog.class.getClassLoader().getResourceAsStream("com/cse/exodex/datasets/constellations.txt.gz");
