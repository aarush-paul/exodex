...
import com.cse.exodex.datasets.identifiers.BayerFlamsteed;
...
public class HYGDatabase implements StarCatalog {
  ...
  public HYGDatabase() throws IOException {
    ...
    Scanner wikiLinks = new Scanner(new GZIPInputStream(HYGDatabase.class.getClassLoader()
        .getResourceAsStream("com/cse/exodex/datasets/hyg_wikipedia_links.txt.gz")));
    ...
    InputStream resourceAsStream = HYGDatabase.class.getClassLoader().getResourceAsStream("com/cse/exodex/datasets/hygdata_v3.csv.gz");
